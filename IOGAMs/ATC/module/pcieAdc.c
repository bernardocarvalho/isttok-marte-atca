//******************************************************************************
//    $Log: pcieAdc.c,v $
//    Revision 1.40  2009/09/22 13:36:58  aneto
//    The software trigger after the startup of acquisition is now working.
//    The acquisition had to be enabled beforehand.
//
//    Revision 1.39  2009/06/25 15:13:25  ppcc_dev
//    Cannot use msleep within RTAI
//
//    Revision 1.38  2009/06/22 16:57:02  aneto
//    Software trigger was updated accordingly to last specifications.
//    Only applies to versions of the firmware greater than 2.
//
//    Revision 1.37  2009/05/27 10:22:57  aneto
//    The older firmware revision must be masked to 15 bits.
//    This is due to a bug in the RTM firmware.
//
//    Revision 1.36  2009/05/21 15:19:43  ppcc_dev
//    Small typos
//
//    Revision 1.35  2009/04/20 16:28:46  aneto
//    The DACs are now true 16 bit
//
//    Revision 1.34  2009/04/02 14:01:30  aneto
//    Get the number of digital inputs from the firmware version
//
//    Revision 1.33  2009/04/01 16:25:51  aneto
//    The number of input digital channels is always the same, with or without RTM
//
//    Revision 1.32  2009/04/01 15:10:36  aneto
...
//
//    Revision 1.31  2009/03/31 08:11:37  aneto
//    Support for multiple input
//
//    Revision 1.30  2009/01/26 09:21:15  aneto
//    linux support
//
//    Revision 1.29  2008/11/21 14:17:27  ppcc_dev
//    This version works with the new firmware: jet clock+trigger
//
//    Revision 1.28  2008/09/30 10:36:04  ppcc_dev
//    Minor modifications to both driver and low level module
//
//    Revision 1.27  2008/09/09 09:29:15  fpiccolo
//    Modified driver structure.
//    Added SingleATCAModule class
//    Added Writing facilities
//
//    Revision 1.26  2008/09/04 11:48:52  ppcc_dev
...
//
//    Revision 1.25  2008/08/20 16:34:36  ppcc_dev
//    Added PulseStart to reset the internal counter to 0 when using the SoftTrigger option
//
//    Revision 1.24  2008/08/01 14:08:32  rvitelli
//    First working version
//
//    Revision 1.23  2008/07/28 13:29:28  rvitelli
//    Minor bug
//
//    Revision 1.22  2008/07/28 13:27:42  rvitelli
//    Work in progress /2
//
//    Revision 1.21  2008/07/28 12:43:42  rvitelli
//    Work in progress
//
//    Revision 1.20  2008/07/17 17:04:45  rvitelli
//    Added soft trigger
//
//    Revision 1.19  2008/06/23 14:11:24  rvitelli
//    *** empty log message ***
//
//    Revision 1.18  2008/06/20 10:54:20  rvitelli
//    Added the GetBufferAddress exported function.
//
//    Revision 1.17  2008/06/12 13:47:01  rvitelli
//    Added buffer reader RTtask & RTAI (de)init in _probe and _remove functions, commented out chardev functions.
//
//    Revision 1.16  2008/06/11 15:41:14  rvitelli
//    Corrected tabulations
//
//    Revision 1.15  2008/06/11 15:25:18  aneto
//    Works with the old firmware
//
//    Revision 1.14  2008/06/11 13:21:31  rvitelli
//    Deleted ununsed global_pdev.
//
//    Revision 1.13  2008/06/11 13:13:04  rvitelli
//    Code reorganization, added new management functions.
//
//    Revision 1.12  2008/06/11 09:28:21  rvitelli
//    Corrected minor bug, added en/disable acquisition functions
//
//    Revision 1.11  2008/06/11 08:47:04  rvitelli
//    Added DMA functions, general cleanup, deleted non-RTAI code.
//
//    Revision 1.10  2008/06/11 08:17:41  rvitelli
//    Added IRQ (un)install functions
//
//    Revision 1.9  2008/06/09 15:12:07  aneto
//    Minor mods
//
//    Revision 1.8  2008/06/09 14:45:15  aneto
//    Clean up
//
//    Revision 1.7  2008/06/09 14:35:15  rvitelli
...
int configurePCI(struct pci_dev *pdev, PCIE_DEV *pcieDev) {
    ...
    for (i = 0; i < 2; i++) {
		...
		printk("BAR: %d\n", i);
		printk("pci_resource_start(pdev, i): %llu\n", pci_resource_start(pdev, i));
		//printk("pci_resource_end(pdev, i): %llu\n", pci_resource_end(pdev, i));
		printk("pci_resource_len(pdev, i): %llu\n", pci_resource_len(pdev, i));
		printk("pci_resource_flags(pdev, i): %lu\n", pci_resource_flags(pdev, i));
		
		//printk("diff: %llu\n", pci_resource_end(pdev, i) - pci_resource_start(pdev, i));		
        // virtual addr
        pcieDev->memIO[i].vaddr = ioremap_nocache(pcieDev->memIO[i].start,
                pcieDev->memIO[i].len);
        printk("pcieDev->memIO[i].start: %lu, pcieDev->memIO[i].len: %lu\n",pcieDev->memIO[i].start, pcieDev->memIO[i].len);
