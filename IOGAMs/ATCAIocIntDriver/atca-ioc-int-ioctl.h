...
#define PCIE_ATCA_IOCT_INTG_RST_SET   _IO(PCIE_ATCA_IOC_MAGIC, 12)
#define PCIE_ATCA_IOCT_INTG_RST_UNSET _IO(PCIE_ATCA_IOC_MAGIC, 13)
...
#define PCIE_ATCA_IOCS_INTEGRAL_DECIM       _IOW(PCIE_ATCA_IOC_MAGIC, 43, u_int32_t)
#define PCIE_ATCA_IOCG_INTEGRAL_DECIM       _IOR(PCIE_ATCA_IOC_MAGIC, 44, u_int32_t)
