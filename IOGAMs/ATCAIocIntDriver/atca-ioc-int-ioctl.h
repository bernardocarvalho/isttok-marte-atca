...
//#define PCIE_ATCA_IOCS_COUNTER_INTEGRAL     _IOW(PCIE_ATCA_IOC_MAGIC, 40, u_int32_t)
//#define PCIE_ATCA_IOCG_COUNTER_INTEGRAL     _IOR(PCIE_ATCA_IOC_MAGIC, 41, u_int32_t)
